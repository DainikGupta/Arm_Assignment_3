...
;FINAL VALUE IS STORED IN R1
	...
	AREA    exponent,CODE,READONLY
        ...
        ENTRY
__main    FUNCTION
			MOV R6, #0				;REGISTER THAT STORES WHAT LOGIC IS TO BE IMPLEMENTED
			MOV R9, #-1
			B NN
...
RESULT	VLDR.F32 S10, =0.5			;THIS IS TO PRINT TRUTH TABLE OF A LOGIC GATE
		VCMP.F32 S8, S10
...
PRINT_LOGIC		MOV R9, #-1		;THIS IS TO PRINT ALL LOGIC TRUTH TABLES
				ADD R6, R6, #1
				CMP R6, #6
				BGT STOP
				BLE NN
